...
export class TransactionFeeComponent implements OnInit, OnChanges, AfterViewInit {
  ...
  constructor(private _fb: FormBuilder,
    ...
    this.feeService = new TransactionFeeService();
  ...
  ngOnChanges(changes: SimpleChanges) {
    ...
    if (changes['transFeeModel']) {
      ...
      TransactionFeeService.mapDataModelToFormModel(dataModel, (<FormGroup>this.transFeeFormLocalModel));
    }
  }
  ...
  onblur() {
    ...
    TransactionFeeService.mapFormModelToDataModel((<FormGroup>this.transFeeFormLocalModel),
      this.transFeeModel);
  }
