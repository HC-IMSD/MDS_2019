  ...
  activityTypeOnblur() {
    if (this.transDetailsFormLocalModel.controls.activityType.value) {
      if (this.transDetailsFormLocalModel.controls.activityType.value === this.rawActTypes[1].id) {
        ...
        this.transDescList = TransactionDetailsService.getPRVLDADescriptions(this.lang);
      } else if (this.transDetailsFormLocalModel.controls.activityType.value === this.rawActTypes[11].id) { // 'B02-20200417-01'
        this.transDescList = TransactionDetailsService.getCOVID19Descriptions(this.lang);
      } else if (this.transDetailsFormLocalModel.controls.activityType.value === this.rawActTypes[12].id) { // 'B02-20200417-02'
